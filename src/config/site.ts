...
import { InstagramIcon, LinkedlnIcon, TwitterIcon, FacebookIcon } from "@/assets/icons";
...
export const contacts = {
    phone:"+234 679 81819",
    location:"27,Alara Street Yaba 100012 Lagos State",
}
...
export const siteConfig = {
  ...
  PrivacyPolicy:{
    policy: "At getlinked tech Hackathon 1.0, we value your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your data when you participate in our techhackathon event. By participating in our event, you consent to the practices described in this policy.",
    standardLicense:[
      "The Standard License grants you a non-exclusive right to and register for our event",
